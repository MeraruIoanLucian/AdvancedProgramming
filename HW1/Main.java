...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Numar de muchii: " + m);
        System.out.println("Grad maxim Δ(G): " + maxDegree);
        System.out.println("Grad minim δ(G): " + minDegree);
        System.out.println("Suma gradelor: " + sumDegrees + " (ar trebui sa fie " + (2 * m) + ")");
        if (sumDegrees == 2 * m)
            System.out.println("Suma gradelor este corecta.");
        else
            System.out.println("Suma gradelor nu este corecta.");
    }
